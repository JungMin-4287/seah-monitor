...
| Rig Count(후행) | 5 | 0.75 | 3.75 | 현재 558기 / 전주 대비 +7기. ※후행지표(리그당생산량 24배↑) — 가중치 최소. |
...
- latest: 558
- previous: 551
- comment: 현재 558기 / 전주 대비 +7기. ※후행지표(리그당생산량 24배↑) — 가중치 최소.
...
- comment: $61.61 | 1W:+1.7% 1M:-0.7% 3M:+16.1% 세계1위 OCTG peer, 가격선행지표
...
- score: 0.0
- near_52w_high: False
- volume_ratio_20d: 0.5499874271937388
...
- positive_1w: 4/7
- positive_1m: 5/7
- ticker_returns: DNOW:-1%/+3%  TS:+2%/-1%  BKR:+3%/-4%  HAL:-1%/+3%  SLB:+3%/+2%  HP:+2%/+5%  PTEN:-1%/+9%
- comment: 1W 4/7상승(0.75) / 1M 5/7상승(0.75) → 0.75
