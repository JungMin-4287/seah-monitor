...
- 생성시각: 2026-05-21 23:32:11
- 현재가: 170900.0
- 거래량 배율(20일): 0.5758168436872145
- 52주 고가권: False
...
| Tenaris(TS) OCTG선행 | 10 | 0.475 | 4.75 | $61.77 | 1W:+0.3% 1M:+0.6% 3M:+17.6% 세계1위 OCTG peer, 가격선행지표 |
| SeAH Wind ★ | 12 | 1.0 | 12.0 | 긍정40/부정0건(21일) [영문10+한국어14건] | 영국CfD AR8·CIB 유일수혜. 수주잔고~2조, 26H2 매출인식. |
...
| US Proxy 주가군 | 12 | 0.9 | 10.8 | 1W 6/7상승(0.75) / 1M 7/7상승(1.0) → 0.9 |

## 시나리오
저점=11.4x  약한=5.7x  기본=3.8x  강세=2.6x  슈퍼=1.9x
...
- comment: $61.77 | 1W:+0.3% 1M:+0.6% 3M:+17.6% 세계1위 OCTG peer, 가격선행지표
...
- kr_news_count: 14
- en_news_count: 10
- comment: 긍정40/부정0건(21일) [영문10+한국어14건] | 영국CfD AR8·CIB 유일수혜. 수주잔고~2조, 26H2 매출인식.
- 뉴스:
...
- total_eps: 81000
- forward_per: 2.1
- scenarios: 저점=11.4x  약한=5.7x  기본=3.8x  강세=2.6x  슈퍼=1.9x
...
- score: 0.0
- near_52w_high: False
- volume_ratio_20d: 0.5758168436872145
...
- positive_1w: 6/7
- positive_1m: 7/7
- ticker_returns: DNOW:-3%/+4%  TS:+0%/+1%  BKR:+2%/+2%  HAL:+2%/+6%  SLB:+3%/+5%  HP:+1%/+6%  PTEN:+1%/+10%
- comment: 1W 6/7상승(0.75) / 1M 7/7상승(1.0) → 0.9
